          ...
          <Card className="p-8">
            <div className="text-center mb-4">
              ...
              <p className="text-text-gray mt-2">
                Sign in and face the truth about your hands.
              </p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
             ...
             <div className="relative my-6">
               ...
               <div className="relative flex justify-center text-sm">
                 <span className="px-2 bg-white text-text-gray">Or continue with</span>
               </div>
             </div>
            ...
            <p className="text-text-gray text-sm mt-2">
              Get your honest hand rating and discover what your hands really say about you.
            </p>
            </div>
          </Card>
        </div>
